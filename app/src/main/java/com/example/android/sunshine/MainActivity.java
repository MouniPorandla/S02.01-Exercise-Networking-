...
public class MainActivity extends AppCompatActivity {
    ...
    private void LoadWeatherData() {
        ...
        new WeatherTaskfetching().execute(preferredlocation);
    }
    ...
    public class WeatherTaskfetching extends AsyncTask<String,Void,String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            String preferredlocation = params[0];
            URL RequestedWeatherURL = NetworkUtils.buildUrl(preferredlocation);
            try
            {String Data_of_Weather = NetworkUtils.getResponseFromHttpUrl(RequestedWeatherURL);
                String[] normalData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, Data_of_Weather);
                return normalData;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
...
@Override
        protected  void onPostExecute(String[] Data_of_Weather)
{
    if (Data_of_Weather != null) {
                for (String s : Data_of_Weather)
                {
